...
export const ARTICLES: Article[] = [
  {
    ...
    body: [
      ...
      p("This is also where designing and building in one team earns its keep: the person drawing the view can look at the real shape of the data rather than requesting a sample and waiting a week. It is a large part of why we keep [web development](/services/web-development) in the same room as the design work."),
